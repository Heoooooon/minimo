...
import 'package:oomool/data/repositories/community_repository.dart';
import 'package:oomool/domain/models/question_data.dart';
...
class MockCommunityRepository implements CommunityRepository {
  ...
  Future<List<QuestionData>> getQuestions({
    ...
    if (sort.startsWith('-')) {
      ...
      sorted.sort(
        (a, b) =>
            (a.created ?? DateTime(0)).compareTo(b.created ?? DateTime(0)),
      );
    }
  ...
  Future<QuestionData> createQuestion(QuestionData data) async {
    ...
    debugPrint(
      '[MockCommunityRepository] Created question: ${newQuestion.title}',
    );
    return newQuestion;
  }
