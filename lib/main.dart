    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          runSpacing: 8,
          children: [
            const AppChip(label: 'Primary', type: AppChipType.primary),
            const AppChip(label: 'Secondary', type: AppChipType.secondary),
            const AppChip(label: 'Success', type: AppChipType.success),
            const AppChip(label: 'Error', type: AppChipType.error),
            const AppChip(label: 'Neutral', type: AppChipType.neutral),
